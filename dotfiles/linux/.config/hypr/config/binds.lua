...
-- Change focus
hl.bind(mainMod .. " + Left",  function() EVA_GRID_FOCUS("left") end)
hl.bind(mainMod .. " + Right", function() EVA_GRID_FOCUS("right") end)
hl.bind(mainMod .. " + Up",    function() EVA_GRID_FOCUS("up") end)
hl.bind(mainMod .. " + Down",  function() EVA_GRID_FOCUS("down") end)
...
hl.bind(mainMod .. " + Equal", function() EVA_GRID_RESIZE(0.05) end, { repeating = true })
hl.bind(mainMod .. " + Minus", function() EVA_GRID_RESIZE(-0.05) end, { repeating = true })
...
-- Screen Capture
hl.bind(mainMod .. " + P",     hl.dsp.exec_cmd(home .. "/.local/bin/screenshot-region-clipboard"))
...
-- Universal editing shortcuts. These translate macOS-style Super keys to the
...
-- image clipboard data is forwarded as Ctrl+V for Copilot attachments.
hl.bind(mainMod .. " + C", hl.dsp.send_shortcut({ mods = "CTRL", key = "C" }))
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd(home .. "/.local/bin/paste-clipboard-smart"))

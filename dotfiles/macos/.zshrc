...
if [[ -r /opt/homebrew/share/zsh-autocomplete/zsh-autocomplete.plugin.zsh ]]; then
  ...
  zstyle ':autocomplete:*:unambiguous' format $'%{\e[38;2;154;134;184m%}common:%{\e[0m%} %{\e[38;2;180;141;219m%}%d%{\e[0m%}'
  zstyle ':completion:*:*' matcher-list 'm:{[:lower:]-}={[:upper:]_}' '+r:|[.]=**'
  zstyle ':completion:*' list-colors ${(s.:.)LS_COLORS}
  zstyle ':completion:*' menu select
  zstyle ':completion:*' group-name ''
  zstyle ':completion:*:descriptions' format $'%{\e[38;2;180;141;219m%}%B%d%b%{\e[0m%}'
  zstyle ':completion:*:messages' format $'%{\e[38;2;154;134;184m%}%d%{\e[0m%}'
...
if [[ -r /opt/homebrew/share/zsh-autosuggestions/zsh-autosuggestions.zsh ]]; then
  ZSH_AUTOSUGGEST_HIGHLIGHT_STYLE='fg=#9A86B8'
...
if [[ -r /opt/homebrew/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh ]]; then
  ...
  ZSH_HIGHLIGHT_STYLES[comment]='fg=#9A86B8,italic'
